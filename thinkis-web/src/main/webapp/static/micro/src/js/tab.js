...
layui.define(['jquery', 'element', 'nprogress', 'utils'], function(exports) {
    ...
    var Tab = function() {
        this.config = {
            elem: undefined,
            // mainUrl: ctx+'/desktop',
            mainUrl: ctx+'/telecom/homemeasure/tMap',
            renderType: 'iframe',
            openWait: true
        };
        this.v = '1.0.5';
    ...
    var _tab = {
        ...
        createTabDom: function() {
            ...
            var tpl = [
                    ...
                    '<li class="layui-this" lay-id="-1" data-url="' + _config.mainUrl + '"><i class="layui-icon">&#xe60d;</i>定点地图</li>',
                    '</ul>',
        ...
        tabAdd: function(options) {
            ...
            var title = options.title,
                icon = options.icon,
                url = options.url.indexOf("http://")==0?options.url:ctx+options.url,
                id = options.id,
