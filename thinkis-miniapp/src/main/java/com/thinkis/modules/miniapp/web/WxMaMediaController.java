...
import com.thinkis.modules.miniapp.config.WxMaConfiguration;
 ...
 */
@RestController
@RequestMapping("${apiPath}/miniapp/media/")
public class WxMaMediaController {
     ...
     * 下载临时素材
     */
    @RequestMapping(value = "/download/{mediaId}",method = RequestMethod.GET)
