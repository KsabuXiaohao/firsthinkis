...
public class Page<T> {
	...
	public String toString() {
		...
		sb.append("<div class=\"layui-table-page\">");
		sb.append("<div id=\"layui-table-page1\">");
		sb.append("<div class=\"layui-box layui-laypage layui-laypage-default\" id=\"layui-laypage-1\">");
		
		if (pageNo == first) {// 如果是首页
			sb.append("<a href=\"javascript:;\" class=\"layui-laypage-prev layui-disabled\" data-page=\"0\"><i class=\"layui-icon\">&#xe603;</i></a>");
		} else {
			sb.append("<a href=\"javascript:;\" class=\"layui-laypage-prev \" data-page=\"0\" onclick=\""+funcName+"("+prev+","+pageSize+",'"+funcParam+"');\"><i class=\"layui-icon\">&#xe603;</i></a>");
		}
		...
		if (begin > first) {
			...
			for (i = first; i < first + slider && i < begin; i++) {
				sb.append("<a href=\"javascript:;\" data-page=\"" + (i + 1 - first) + "\" onclick=\""+funcName+"("+i+","+pageSize+",'"+funcParam+"');\">" + (i + 1 - first) + "</a>");
			}
			if (i < begin) {
		...
		for (int i = begin; i <= end; i++) {
			if (i == pageNo) {
				sb.append("<span class=\"layui-laypage-curr\"><em class=\"layui-laypage-em\"></em><em>" + (i + 1 - first) + "</em></span>");
			} else {
				sb.append("<a href=\"javascript:;\" data-page=\"" + (i + 1 - first) + "\" onclick=\""+funcName+"("+i+","+pageSize+",'"+funcParam+"');\">" + (i + 1 - first) + "</a>");
			}
		}
		...
		if (pageNo == last) {
			sb.append("<a href=\"javascript:;\" class=\"layui-laypage-next layui-disabled\" data-page=\""+next+"\"><i class=\"layui-icon\">&#xe602;</i></a>");
		} else {
			sb.append("<a href=\"javascript:;\" class=\"layui-laypage-next\" data-page=\""+next+"\" onclick=\""+funcName+"("+next+","+pageSize+",'"+funcParam+"');\"><i class=\"layui-icon\">&#xe602;</i></a>");
		}

		sb.append("<span class=\"layui-laypage-skip\">当前<input type=\"text\" min=\"1\" value=\""+pageNo+"\" class=\"layui-input\" ");
		sb.append("onkeypress=\"var e=window.event||event;var c=e.keyCode||e.which;if(c==13)");
		...
		sb.append("</span>");
		sb.append("<span class=\"layui-laypage-count\">共 " + count + "条</span>");
