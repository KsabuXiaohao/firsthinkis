 ...
 */
package com.thinkis.common.utils.http;
...
public class Constant {
    ...
    public static final String BASE_URL = Global.getConfig("ouath.dxkf.url");

    //please replace the appId and secret, when you use the demo.
    public static final String APPID = Global.getConfig("ouath.dxkf.appid");
    public static final String SECRET = Global.getConfig("ouath.dxkf.secret");
    ...
    public static String SELFCERTPATH = Global.getConfig("ouath.dxkf.secret.path");
    public static String TRUSTCAPATH = Global.getConfig("ouath.dxkf.trustca.path");
