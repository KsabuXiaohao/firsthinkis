...
public class JedisUtils {
	...
	private static JedisPool jedisPool = new JedisPool(genericObjectPoolConfig,Global.getConfig("dxkf.redis.url"),Integer.parseInt(Global.getConfig("dxkf.redis.port")),Integer.parseInt(Global.getConfig("dxkf.redis.timeout")),Global.getConfig("dxkf.redis.pwd"));
