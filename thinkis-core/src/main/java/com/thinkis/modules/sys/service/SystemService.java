...
import com.thinkis.common.security.Digests;
...
import com.thinkis.common.utils.Encodes;
import com.thinkis.common.utils.StringUtils;
import com.thinkis.common.web.Servlets;
...
import com.thinkis.modules.sys.utils.LogUtils;
...
//			systemRealm.clearAllCachedAuthorizationInfo();
	...
	public User createUser(User user){
		...
		if(loginName !=null && this.getUserByLoginName(loginName) == null) {
			// 设置默认注册公司及部门
			...
			// 如果用户类型为空，则设置用户类型为普通用户
			if(StringUtils.isBlank(user.getUserType())){
				user.setUserType(USER_TYPE);
			}
			user.setLoginDate(new Date());
			user.setCreateBy(new User("1"));//系统管理员
			user.setCreateDate(new Date());
			user.setUpdateBy(new User("1"));//系统管理员
...
//		systemRealm.clearAllCachedAuthorizationInfo();
	...
	public static boolean printKeyLoadMessage(){
		...
		sb.append("\r\n======================================================================\r\n");
		sb.append("\r\n    欢迎使用 "+Global.getConfig("productName")+"  - Powered By http://www.ksabu.com\r\n");
		sb.append("\r\n======================================================================\r\n");
