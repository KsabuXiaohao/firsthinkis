...
import com.thinkis.modules.sys.service.AreaService;
...
//		}
	...
	@ResponseBody
	public Result save(Area area, Model model, RedirectAttributes redirectAttributes) {
		if (!beanValidator(model, area)){
			return ResultGenerator.genFailResult((String)model.asMap().get("message"));
		}
		areaService.save(area);
		return ResultGenerator.genSuccessResult("保存区域'" + area.getName() + "'成功");
	}
