...
import com.thinkis.modules.sys.dao.MenuDao;
import com.thinkis.modules.sys.dao.OfficeDao;
import com.thinkis.modules.sys.dao.RoleDao;
import com.thinkis.modules.sys.dao.UserDao;
...
public class UserUtils {
	...
	public static final String CACHE_FIRST_MENU_LIST = "firstMenuList";
	public static final String CACHE_CHILD_MENU_LIST = "childMenuList";
	...
	public static void clearCache(){
		...
		removeCache(CACHE_FIRST_MENU_LIST);
		removeCache(CACHE_CHILD_MENU_LIST);
	...
	public static List<Menu> getFirstMenuList(){
		@SuppressWarnings("unchecked")
		List<Menu> firstMenuList = (List<Menu>)getCache(CACHE_FIRST_MENU_LIST);
		if (firstMenuList == null){
			...
			firstMenuList = new ArrayList<Menu>();
			for(Menu menu : menuList){
				if("1".equals(menu.getIsShow())&&"1".equals(menu.getParent().getId())){
					firstMenuList.add(menu);
				}
			}
			putCache(CACHE_FIRST_MENU_LIST, firstMenuList);
		}
