 ...
 */
package com.thinkis.modules.cms.entity;
...
public class Site extends DataEntity<Site> {
	...
	public static final String DEFAULT_DOMAIN = "1";//默认站点
	public static final String NOT_DEFAULT_DOMAIN = "0";//非默认站点
	...
	public static String defaultSiteId(){
		return CmsUtils.getDefaultSite().getId();
	}
    ...
    /**
   	 * 模板路径
   	 */
   	public static final String TPL_BASE = "/WEB-INF/views/templates";

    /**
   	 * 获得模板方案路径。如：/WEB-INF/views/templates/
   	 *
   	 * @return
   	 */
	...
	public String getDelFlagLabel() {
		return DictUtils.getDictLabel(this.delFlag, "del_flag", "");
	}

	public String getDelFlagValue() {
		return this.delFlag;
	}
}