...
import com.thinkis.modules.sys.utils.SequenceUtils;
...
import com.thinkis.modules.cms.dao.ArticleDao;
import com.thinkis.modules.cms.dao.ArticleDataDao;
import com.thinkis.modules.cms.dao.CategoryDao;
...
//		dc.createAlias("category.site", "category.site");
		if (article.getCategory()!=null && StringUtils.isNotBlank(article.getCategory().getId()) && !Category.isRoot(article.getCategory().getId())){
			...
			article.setCategory(new Category("",article.getCategory().getSite()));
		}
...
//		return dao.find(page, dc);
	...
	public void save(Article article) {
		...
		if (StringUtils.isBlank(article.getId())){
			...
			article.setId(SequenceUtils.getKey("ARTICLE_ID"));
			article.preInsert();
